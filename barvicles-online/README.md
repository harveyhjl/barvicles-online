...
## v29 update — Beth/fun pack

Added:
- Quick reactions / taunts:
  - 😂, 🙄, 👑, NOPE., Jammy, Robbed, Skill issue, Beth clears
- Custom player colours:
  - green, pink, purple, blue, orange, red
- Silly card voice lines:
  - each played card now logs a small line like “NOPE”, “Dump time”, “Swap robbery”, etc.
- End-of-round awards:
  - winner, most nope energy, biggest thief, chaos gremlin, most punished, royal moments, etc.
- Beth Mode:
  - toggle in Fun stuff panel
  - if a player named Beth is in the room, she gets a visible cheeky edge each round:
    - starts with one fewer card
    - if she has no 10, the game tries to swap a weak card for a 10 from the deck
- Bot personalities:
  - BarvBot now gets names like The Menace, The Idiot, The Coward, The Goblin
  - bots sometimes drop chat reactions

No revenge/punishment rule added.
