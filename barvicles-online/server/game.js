...
function normalizeGameState(room) {
  ...
  // If 6/9 chaos says a number is required but nobody has it, the chain is over.
  if (room.sixNine?.active && (!ruleOn(room, "sixNine") || !anyoneHasRank(room, room.sixNine.nextRank))) {
